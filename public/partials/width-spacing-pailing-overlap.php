...
<div class="form-group row js-pailing-overlap-container with-spacing-overlap" style="display:none !important;">
  <label for="length" class="col-sm-5 col-5">Paling Overlap</label>
  <div class="col-sm-4 col-4">
    <input type="text" name="pailing-overlap" value="20" class="js-pailing-overlap form-control form-control-sm">
  </div>
  <div class="col-sm-3 col-3" style="padding-left:0px;">
    <span>mm</span>
  </div>
...
<div class="form-group row not-wa-space-overlap-paling not-wa-js-pailing-spacing-overlap-container not-wa-js-with-spacing-overlap">
  ...
  <div class="col-sm-4 col-4">
    <select name="not-wa-spacing-gap" class="with-spacing-overlap-list with-spacing-overlap not-wa-js-spacing-gap form-control form-control-sm" style="font-size:20px;">
...
<div class="form-group row wa-space-overlap-paling wa-js-pailing-spacing-overlap-container wa-js-with-spacing-overlap">
  <label for="length" class="col-sm-5 col-5">Gap / Overlap</label>
  <div class="col-sm-4 col-4">
    <select name="wa-spacing-gap" class="with-spacing-overlap-list with-spacing-overlap wa-js-spacing-gap form-control form-control-sm" style="font-size:20px;">
      <option value="20">Gap (20mm)</option>
      <option value="0">No Gap (Butt Join)</option>
